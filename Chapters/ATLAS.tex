...
The previously described subdetectors are used in combination to identify particles in \ac{ATLAS}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth]{figures/Detector/particle-doodle.png}
\caption{A schematic of the signatures of Standard Model particles in the \ac{ATLAS} detector that illustrates how the subdetectors are used together to identify particles. Dashed lines indicate a particle trajectory that leaves no detector signature. Figure not drawn to scale. }
