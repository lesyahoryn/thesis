...
The summary in \autoref{fig:excl_limit} includes both right- and left-handed slepton production and cannot be directly compared to the results from \ac{LEP}. Right-handed only or left-handed only, as well as $\stau_1$ and $\stau_2$ limits are shown in \todo{figure when available} and compared to the LEP limit where possible.

\todo{These limit plots are currently being finalized and should be available this week. I will add them here whent they are available.}
