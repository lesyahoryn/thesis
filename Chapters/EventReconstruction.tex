...
In this analysis we use the the \texttt{FCTight} isolation definition for both electrons and muons, detailed in \autoref{tab:iso_defs}. In general, the requirements are stricter for electrons. \todo{why}
...
\todo{describe briefly objects not used in this analysis, jets, MET}
