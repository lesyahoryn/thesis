...
In this analysis the \texttt{FCTight} isolation definition is used for both electrons and muons, detailed in \autoref{tab:iso_defs}. In general, the requirements are stricter for electrons. \todo{why}
